		...
		<div class="navbar-wrapper ">
			...
			<div class="navbar-content scroll-div">
				<ul class="nav pcoded-inner-navbar">
					...
					<li class="nav-item">
						<a href="/admin/about" class="nav-link"><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">เมนูอาหาร</span></a>
					</li>
                    <li class="nav-item">
						<a href="/admin/foodInformation" class="nav-link"><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">ข้อมูลอาหาร</span></a>
					</li>
                    <li class="nav-item">
						<a href="/admin/newsandevents" class="nav-link"><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">ข่าวสาร และ กิจกรรม</span></a>
					</li>
